...
import 'join_household_popup_f_i_n_a_l_model.dart';
export 'join_household_popup_f_i_n_a_l_model.dart';
...
class JoinHouseholdPopupFINALWidget extends StatefulWidget {
  const JoinHouseholdPopupFINALWidget({super.key});

  @override
  State<JoinHouseholdPopupFINALWidget> createState() =>
      _JoinHouseholdPopupFINALWidgetState();
}

class _JoinHouseholdPopupFINALWidgetState
    extends State<JoinHouseholdPopupFINALWidget> {
  late JoinHouseholdPopupFINALModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => JoinHouseholdPopupFINALModel());

    _model.textFieldTextController ??= TextEditingController(
        text: valueOrDefault<String>(
      _model.joinCodeInput,
      'xx',
    ));
            ...
            children: [
              ...
              FFButtonWidget(
                onPressed: () async {
                  ...
                  } else if (_model.household?.joinCode ==
                      _model.joinCodeInput) {
                  } else {
