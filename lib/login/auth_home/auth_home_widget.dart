...
import '/login/signup_info/signup_info_widget.dart';
import '/index.dart';
                                                      ...
                                                      if (currentUserReference
                                                        ...
                                                        if (FFAppState()
                                                          ...
                                                          if ((currentUserDocument
                                                              ...
                                                              .toList()
                                                              .isNotEmpty) {
                                                            _model.resetAppstateHousehold =
                                                                await queryHouseholdsRecordOnce(
                                                              queryBuilder:
                                                                  (householdsRecord) =>
                                                                      householdsRecord
                                                                          .where(
