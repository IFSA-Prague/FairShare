...
import '/chores_screen/create_chore_popup/create_chore_popup_widget.dart';
...
class ChoresHomeWidget extends StatefulWidget {
  ...
  static String routeName = 'ChoresHome';
  static String routePath = '/choresHome';
                                ...
                                StreamBuilder<List<UserChoresRecord>>(
                                  stream: queryUserChoresRecord(
                                    ...
                                    queryBuilder: (userChoresRecord) =>
                                      ...
                                      'household',
                                      isEqualTo: FFAppState().selectedHousehold,
                                    ),
                                  ),
                                  builder: (context, snapshot) {
                                    // Customize what your widget looks like when it's loading.
                                    ...
                                    List<UserChoresRecord>
                                        ...
                                        snapshot.data!;
                                    if (listViewUserChoresRecordList.isEmpty) {
                                      return Center(
                                        child: Container(
                                          height: 65.0,
                                    ...
                                    return ListView.separated(
                                      ...
                                      scrollDirection: Axis.vertical,
                                      itemCount:
                                          listViewUserChoresRecordList.length,
