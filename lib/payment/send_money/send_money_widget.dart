                      ...
                      child: Column(
                        ...
                        children: [
                          Material(
                            ...
                            child: Container(
                              width: MediaQuery.sizeOf(context).width * 0.894,
                              decoration: BoxDecoration(
                                color: FlutterFlowTheme.of(context)
                                    .secondaryBackground,
                                borderRadius: BorderRadius.circular(16.0),
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        FutureBuilder<int>(
                          future: queryPaymentsRecordCount(
                            queryBuilder: (paymentsRecord) => paymentsRecord
                                ...
                                .where(
                                  'hid',
                                  isEqualTo: FFAppState().selectedHousehold?.id,
                                )
                                .where(
                                  'paidStatus',
                                  isEqualTo: false,
                                          ...
                                          return ListView.builder(
                                            ...
                                            itemBuilder:
                                              ...
                                              return FFButtonWidget(
                                                ...
                                                text:
                                                    '${listViewPaymentsRecord.requesterName}: \$${listViewPaymentsRecord.amount.toString()} *${listViewPaymentsRecord.name}*',
